...
deliveryAreaZipCodes.forEach(function (zipCode, index) {
...
// const canWeDeliverTwo = deliveryAreaZipCodes.filter(zipCode === deliveryAreaZipCodes)
// }
// }
...
function change() {
  return deals[0].title.replace("15% Off!", "10% Off!");
}
...
//CODE HERE
function change2() {
  return deals[1].desc.replace("March", "April");
}

console.log(change2().trim());
