...
const empShift1 = new Employee("JOEy", "8:00");
const empShift2 = new Employee("TOM", "10:00");

empShift1.getSchedule();
empShift2.getSchedule();
...
//CODE HERE
const empOne = new Employee("Jess", "12:00");
...
const empManages = new Manager("JOEy", "8:00", ["Drew ", "Barry ", "More"]);

empManages.getEmployees();
/*
    Create a new instance of your class.
...
//CODE HERE
const manager = new Manager("Winston", "8:00", ["Cece ", "Schmidt"]);
